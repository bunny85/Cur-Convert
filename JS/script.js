...
document.converter.euro.value = document.converter.rupee.value * 0.014	
document.converter.dollar.value = document.converter.rupee.value * 0.016
document.converter.pound.value = document.converter.rupee.value * 0.012
document.converter.yen.value = document.converter.rupee.value * 1.74
}
...
document.converter.rupee.value = document.converter.euro.value * 72.03	
}
...
document.converter.rupee.value = document.converter.dollar.value * 64.43
}
...
document.converter.rupee.value = document.converter.pound.value * 81.95
}
...
document.converter.rupee.value = document.converter.yen.value * 0.58
}